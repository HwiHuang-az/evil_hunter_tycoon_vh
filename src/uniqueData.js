...
export const uniques = [
  ...
  { name: '질풍의 경갑', part: '경갑', mode: '카오스 부스트', stage: '1~10단',
    option: '이동속도 증가량의 3~10%만큼 공격력 증폭(공격력 증폭 30% 제한), 이동속도가 15~30% 빨라짐' },
  ...
  { name: '저거너트 헬름', part: '투구', mode: '카오스 부스트', stage: '1~10단',
    option: '막장 성격인 헌터의 이동속도와 전체공격력 30% 증가, 체력 20~30% 증가' },
  ...
  { name: '진 질풍의 경갑', part: '경갑', mode: '어비스 부스트', stage: '1~10단',
    option: '이동속도 증가량의 3~10%만큼 공격력 증폭(공격력 증폭 40% 제한), 이동속도가 17~32% 빨라짐' },
